...
const TvShowsdetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      {/* part 4 similar tv shows */}
      <div className="mt-[5%]">
        <h1 className="text-4xl font-semibold text-white mb-5 flex justify-start w-full h-[8vh] bg-zinc-900 p-2 rounded-md">Similar TV Shows</h1>
        <HorizontalsCards
